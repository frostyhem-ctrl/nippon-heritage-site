...
import { DEFAULT_SITE_URL, getSiteUrl } from "./env";
...
const pageMeta = {
  ...
  thanks: {
    fr: {
      title: "Merci | Demande envoyee a Nippon Heritage",
      description: "Confirmation d'envoi de votre demande a Nippon Heritage.",
    },
    en: {
...
const templatePaths = {
  ...
  "merci.html": path.join(process.cwd(), "merci.html"),
};
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Import moto Japon, motos japonaises de collection, sportives 2 temps et 4 temps, remise en etat et vente en France.",
        areaServed: "FR",
        email: "frostyhem@gmail.com",
        parentOrganization: {
          "@id": `${siteUrl}/#organization`,
...
export function buildProductMetadata(item) {
  ...
  return {
    ...
    description:
      item.description ||
      `${motorcycleName} disponible chez Nippon Heritage, importee du Japon, selectionnee pour une clientele passionnee de motos japonaises de collection.`,
  };
}
    ...
    "@graph": [
      {
        ...
        description:
          item.description ||
          `${motorcycleName} importee du Japon par Nippon Heritage et proposee a la vente en France.`,
